...
SPECS = [
    ...
    ToolSpec(
        name="app.undo",
        category="app",
        summary="Run Blender undo for the active session",
        command="app.undo",
    ),
    ToolSpec(
        name="app.redo",
        category="app",
        summary="Run Blender redo for the active session",
        command="app.redo",
    ),
    ToolSpec(
        name="app.workspaces",
        category="app",
        summary="List workspaces and report the active workspace",
        command="app.workspaces",
    ),
    ToolSpec(
        name="app.workspace_set",
        category="app",
        summary="Switch the active window to a named workspace",
        command="app.workspace_set",
        params={"name": Str(required=True, summary="Workspace name")},
    ),
    ToolSpec(
        name="app.addons",
        category="app",
        summary="List available Blender add-ons with enabled and loaded state",
        command="app.addons",
    ),
    ToolSpec(
        name="app.addon_enable",
        category="app",
        summary="Enable an installed Blender add-on module",
        command="app.addon_enable",
        params={"module": Str(required=True, summary="Add-on module id")},
    ),
    ToolSpec(
        name="app.addon_disable",
        category="app",
        summary="Disable an installed Blender add-on module",
        command="app.addon_disable",
        params={"module": Str(required=True, summary="Add-on module id")},
    ),
    ToolSpec(
        name="app.preferences_summary",
        category="app",
        summary="Report safe high-level user preference values",
        command="app.preferences_summary",
    ),
    ToolSpec(
        name="app.preferences_save",
        category="app",
        summary="Save current Blender user preferences",
        command="app.preferences_save",
    ),
]
