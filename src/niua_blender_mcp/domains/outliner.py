...
SPECS = [
    ...
    ToolSpec(
        name="outliner.view_layers",
        category="outliner",
        summary="List view layers and their layer-collection restriction trees",
        command="outliner.view_layers",
    ),
    ToolSpec(
        name="outliner.view_layer_create",
        category="outliner",
        summary="Create a view layer",
        command="outliner.view_layer_create",
        params={"name": Str(required=True, summary="New view layer name")},
        mutates=True,
        feedback="viewport",
    ),
    ToolSpec(
        name="outliner.view_layer_delete",
        category="outliner",
        summary="Delete a view layer; force is required and the last layer cannot be deleted",
        command="outliner.view_layer_delete",
        params={
            "name": Str(required=True, summary="View layer to delete"),
            "force": Bool(default=False, summary="Confirm render organization change"),
        },
        mutates=True,
        feedback="viewport",
    ),
    ToolSpec(
        name="outliner.layer_collection_set",
        category="outliner",
        summary="Set view-layer collection restrictions for one collection",
        command="outliner.layer_collection_set",
        params={
            "view_layer": Str(required=True, summary="View layer name"),
            "collection": Str(required=True, summary="Collection in the view-layer tree"),
            "exclude": Bool(summary="Exclude collection from this view layer"),
            "viewport": Bool(summary="Visible in this view layer"),
            "holdout": Bool(summary="Holdout in this view layer"),
            "indirect_only": Bool(summary="Indirect-only in this view layer"),
        },
        mutates=True,
        feedback="viewport",
    ),
    ToolSpec(
        name="outliner.orphans_purge",
        category="outliner",
        summary="Purge orphan datablocks; force is always required",
        command="outliner.orphans_purge",
        params={"force": Bool(default=False, summary="Confirm orphan purge")},
        mutates=True,
        feedback="viewport",
    ),
]
