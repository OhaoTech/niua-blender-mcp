...
SPECS = [
    ...
    ToolSpec(
        ...
        params={
            ...
            "asset_class": Enum(ASSET_CLASS_IDS, summary="Layer 2 asset-class profile"),
            "triangle_budget": Int(minimum=0, summary="Optimize-stage triangle budget"),
            "material_budget": Int(minimum=0, summary="Optimize-stage material budget"),
            "texture_budget": Int(minimum=0, summary="Optimize-stage texture budget"),
            ...
            "min_collision_hulls": Int(minimum=0, summary="Optimize-stage minimum collision hull count"),
            "max_collision_oversize_ratio": Float(
                minimum=0.0,
                summary="Optimize-stage maximum collision union oversize ratio",
            ),
            "max_texture_size": Int(minimum=1, summary="Bake/material-stage maximum texture dimension"),
